  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass("GameController"), _dec2 = property({
        ...
        type: SpriteFrame
      }), _dec40 = property(Node), _dec41 = property(Node), _dec42 = property(Prefab), _dec43 = property(Prefab), _dec44 = property(Prefab), _dec45 = property({
        type: Node
      }), _dec46 = property({
        type: Node
      }), _dec47 = property({
        ...
        type: [Button]
      }), _dec52 = property(_crd && NetworkConnect === void 0 ? (_reportPossibleCrUseOfNetworkConnect({
        error: Error()
      }), NetworkConnect) : NetworkConnect), _dec53 = property({
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "bankCard", _descriptor38, this);

          _initializerDefineProperty(this, "pref", _descriptor39, this);

          _initializerDefineProperty(this, "prefL", _descriptor40, this);

          _initializerDefineProperty(this, "Over", _descriptor41, this);

          _initializerDefineProperty(this, "Under", _descriptor42, this);

          _initializerDefineProperty(this, "Tie", _descriptor43, this);

          // private countDownLb: Label;
          _initializerDefineProperty(this, "ToatalAv", _descriptor44, this);

          _initializerDefineProperty(this, "ToatalUser", _descriptor45, this);

          _initializerDefineProperty(this, "PayUser", _descriptor46, this);

          _initializerDefineProperty(this, "BalanceList", _descriptor47, this);

          _initializerDefineProperty(this, "TotalBetLB", _descriptor48, this);

          _initializerDefineProperty(this, "PayUserSprite", _descriptor49, this);

          _initializerDefineProperty(this, "listCancelBet", _descriptor50, this);

          _initializerDefineProperty(this, "NetworkConnect", _descriptor51, this);

          _initializerDefineProperty(this, "AudioController", _descriptor52, this);
        ...
        update(deltaTime) {
          ...
          if (this.NetworkConnect.gameState === "idle" && this.GameStateIdle === false) {
            ...
            this.NetworkConnect.room.onMessage("histories", message => {
              // console.log("History", message.documents);
          ...
          if (this.NetworkConnect.gameState === "payout" && this.GameStatePayOut === false) {
            for (var i = 0; i < this.NetworkConnect.ListLabel.length; i++) {
        ...
        createGridNot(documents) {
          ...
          for (var doc of documents) {
            var prefabType = prefabMap[doc.result];
            ...
            if (prefabType) {
              ...
              var cell = instantiate(prefabType);
              var posX = this.currentColL * this.cellWidth;
              var posY = -this.currentRowL * this.cellHeight;
              cell.position = new Vec3(posX, posY);
              this.prefL.addChild(cell);
              this.currentRowL++;
            } else {
              console.error("Prefab type not found for result: " + doc.result);
            }
          }
        }
      ...
      }), _descriptor38 = _applyDecoratedDescriptor(_class2.prototype, "bankCard", [_dec39], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor39 = _applyDecoratedDescriptor(_class2.prototype, "pref", [_dec40], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor40 = _applyDecoratedDescriptor(_class2.prototype, "prefL", [_dec41], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor41 = _applyDecoratedDescriptor(_class2.prototype, "Over", [_dec42], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor42 = _applyDecoratedDescriptor(_class2.prototype, "Under", [_dec43], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor43 = _applyDecoratedDescriptor(_class2.prototype, "Tie", [_dec44], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor44 = _applyDecoratedDescriptor(_class2.prototype, "ToatalAv", [_dec45], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor45 = _applyDecoratedDescriptor(_class2.prototype, "ToatalUser", [_dec46], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor46 = _applyDecoratedDescriptor(_class2.prototype, "PayUser", [_dec47], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor47 = _applyDecoratedDescriptor(_class2.prototype, "BalanceList", [_dec48], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor48 = _applyDecoratedDescriptor(_class2.prototype, "TotalBetLB", [_dec49], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor49 = _applyDecoratedDescriptor(_class2.prototype, "PayUserSprite", [_dec50], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor50 = _applyDecoratedDescriptor(_class2.prototype, "listCancelBet", [_dec51], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor51 = _applyDecoratedDescriptor(_class2.prototype, "NetworkConnect", [_dec52], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor52 = _applyDecoratedDescriptor(_class2.prototype, "AudioController", [_dec53], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
